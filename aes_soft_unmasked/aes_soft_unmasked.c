#include "aes_soft_unmasked.h"
  ...
  #error "Neither CONFIG_USR_LIB_AES_ALGO_UNMASKED_SIMPLE nor CONFIG_USR_LIB_AES_ALGO_UNMASKED_TABLE is defined! Please define at least one of them ..."
#endif
...
#endif /* CONFIG_USR_LIB_AES_ALGO_UNMASKED_TABLE */
...
int aes_soft_unmasked_setkey_dec(aes_soft_unmasked_context *ctx, const uint8_t *key, uint32_t keybits)
{
	...
	if(aes_soft_unmasked_setkey_enc(&ctxx, key, keybits)){
		goto err;
	}
	ctx->nr = ctxx.nr;
